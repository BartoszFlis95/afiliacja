 ...
 *
 * W odróżnieniu od generateInvoiceAction, która fakturuje samą prowizję
 * platformy, ta obejmuje PEŁNĄ kwotę należną influencerom powiększoną o
 * opłatę platformy. To ta wpłata finansuje wypłaty — bez niej odblokowanie
 * wypłat nie miałoby pokrycia w środkach.
 */
