  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div data-surface="dark"
        className="relative hidden flex-col overflow-hidden bg-sidebar p-10 text-sidebar-foreground lg:flex">
        {/* Subtle gradient orb */}
          ...
          <div className="mt-10 grid grid-cols-2 gap-6">
            {[
              ...
              <div key={label}>
                ...
                <p className="text-sm text-sidebar-foreground/50 mt-0.5">{label}</p>
              </div>
            ))}
          </div>
        </div>
