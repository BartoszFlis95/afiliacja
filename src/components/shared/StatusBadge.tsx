...
> = {
  ...
  PAID:       { label: "Wypłacona",    bg: "bg-purple-50 dark:bg-purple-400/15",  text: "text-purple-700 dark:text-purple-300",  border: "border-purple-200 dark:border-purple-400/30",  dot: "bg-purple-500" },
  COMPLETED:  { label: "Zrealizowana", bg: "bg-purple-50 dark:bg-purple-400/15",  text: "text-purple-700 dark:text-purple-300",  border: "border-purple-200 dark:border-purple-400/30",  dot: "bg-purple-500" },
