...
import { fieldBase, microLabel } from "@/components/ui/field-styles"
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        fieldBase,
        "flex items-center justify-between gap-1.5 whitespace-nowrap data-[placeholder]:text-muted-foreground/60 data-[size=sm]:h-9 [&>span]:line-clamp-1 [&>span]:flex [&>span]:items-center [&>span]:gap-1.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
