...
// mimo że nowa strona już się załadowała. Wejście animuje się przez
// prawdziwy atrybut data-state=open (poprzednie "data-open:" nigdy
// nie pasowało do żadnego realnego atrybutu Radix).
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/20 duration-100 supports-[backdrop-filter]:backdrop-blur-sm data-[state=open]:animate-in data-[state=open]:fade-in-0",
        className
      )}
      {...props}
    />
